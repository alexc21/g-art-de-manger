...
<body id="page-top" class="index">
	...
	<div class="master-wrapper">
		...
		<section id="welcome">
		<h2>creation de votre produit</h2>
			<div class="section-inner nopaddingbottom">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div id="message"></div>
							<form method="post" id="creaform"	action="<%=request.getContextPath()%>/produit/creerProd">

<!-- 								<label>id du produit : </label>  -->
<!-- 									<input type="number" min="1" class="form-control" name="idProd">  -->
								...
								<select name="lieu" >
									<jsp:useBean id="StockLieus" class="metier.lieu.Lieus"
										scope="request" />
									<%
								...
								<label>mettre se produit en favoris : </label> 
								<select name="fav">
								...
								<input class="btn btn-primary mt30  " type="submit"	value="Enregistrer" />
							</form>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 text-right match-height">
						<div class="vertical-center">
							<span class="copyright">Copyright 2019. Designed by
								DISTINCTIVE THEMES</span>
						</div>
					</div>
				</div>
			</div>
